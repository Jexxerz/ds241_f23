...
```{r}
census_api_key("b0c5ce14a69ee4db115c3101a8b878883731f766")
...
```{r}
dfv = get_acs(geography = "tract",
              variables = c("pop"="B01001_001",
                            "vehicles" = "B08201_001",
                            "lone_travelers" = "B08541_006"),
...
```{r} 
df_census_adj = df_cens |> st_transform(4326)

df_j=st_join(df_census_adj, neigh2, largest = TRUE)
```
